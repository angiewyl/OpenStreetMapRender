...
public:
    Render(Model &model);
    void Display(io2d::output_surface &surface, const std::vector<Model::Node>& input_route, const std::vector<Model::Node>& non_precise_points);
...
private:
    ...
    void DrawPath(io2d::output_surface &surface, const std::vector<Model::Node>& input_route);
    void DrawPoints(io2d::output_surface &surface, const float x, const float y, const io2d::brush& foreBrush);
