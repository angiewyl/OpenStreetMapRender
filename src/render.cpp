...
Render::Render(Model &model) : m_Model(model)
{
    BuildRoadReps();
    BuildLanduseBrushes();
}
...
void Render::Display(io2d::output_surface &surface, const std::vector<Model::Node>& input_route, const std::vector<Model::Node>& non_precise_points)
{
...
void Render::DrawPath(io2d::output_surface &surface, const std::vector<Model::Node>& input_route)
{
...
void Render::DrawPoints(io2d::output_surface &surface, const float x, const float y, const io2d::brush& foreBrush)
{
